...
//------------------------------------------------------
app.post('/sendComparison/r/:recipientMail/as/:senderSummonerName/ar/:senderSummonerRegion/bs/:recipientSummonerName/br/:recipientSummonerRegion', function(req, res) {
    try {
        // string generated by canvas.toDataURL()
        var img = req.body.data;
        // strip off the data: url prefix to get just the base64-encoded bytes
        var data = img.replace(/^data:image\/\w+;base64,/, "");
        mailer.sendEmail(req.params.recipientMail, req.params.senderSummonerName, req.params.senderSummonerRegion,  req.params.recipientSummonerName, req.params.recipientSummonerRegion, data);
        res.send('Success')
    } catch (e) {
